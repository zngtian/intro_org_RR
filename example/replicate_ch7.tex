...
\label{sec:orgc71cfce}
\subsection*{Testing a single coefficient}
\label{sec:orgd0c59bb}
...
\label{sec:orge36f773}
\begin{itemize}
\item Zero restrictions
\label{sec:org0cce8e4}
