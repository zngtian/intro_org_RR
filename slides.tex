...
\begin{frame}[fragile,label={sec:orgda37194}]{Mathematics}
...
\begin{frame}[fragile,label={sec:orgb4b1809}]{Table}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orga6af316}]{Calculation in a table}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org57d3567}]{Exporting}
 \begin{itemize}
...
\label{sec:orgc39bb62}

\begin{frame}[label={sec:org71a5727}]{A sneak peek of my agenda}
...
\begin{frame}[fragile,label={sec:orgea8b593}]{To-do items}
...
\begin{frame}[fragile,label={sec:org28bd48e}]{Schedule and deadline}
...
\begin{frame}[label={sec:orgbfb004b}]{Agenda view}
...
\label{sec:orgb42ded3}

\subsection{Reproducible research: basics}
\label{sec:orgeeecbf7}

\begin{frame}[label={sec:org0615053}]{What is reproducible research?}
\begin{quote}
...
\begin{frame}[label={sec:org2bd4dce}]{Why should we do reproducible research?}
...
\begin{frame}[label={sec:orgfab4c4f}]{What is a workflow of reproducible research?}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:orge69abe9}]{What are necessary elements of reproducible research?}
...
\label{sec:orgd4314f1}

\begin{frame}[label={sec:orgf2a9a9a}]{What is literate programming?}
...
\begin{frame}[fragile,label={sec:org1137447}]{Results in raw format}
 \begin{verbatim}
...
\begin{frame}[fragile,label={sec:orgac698ba}]{Results in org tables}
 \begin{verbatim}
...
\begin{frame}[fragile,label={sec:org8415ea1}]{Results in figures}
 \begin{verbatim}
...
\begin{frame}[label={sec:orge0085e9}]{The figure generated}
\begin{figure}[htbp]
\centering
...
\begin{frame}[fragile,label={sec:org456a4b3}]{Results in latex}
 \begin{verbatim}
...
\begin{frame}[label={sec:org147cb13}]{The \LaTeX{} table generated}
...
\begin{frame}[label={sec:orgb9403b3}]{An mini example of literate programming}
...
\begin{frame}[label={sec:org679ca9d}]{Tutorial sources}
\begin{description}
