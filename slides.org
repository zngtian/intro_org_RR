...
- Hit <TAB> key at a headline to see and hide the content under it
- S-<TAB>: global cycling.
- M-left and M-right: promote and demote a heading
- C-c C-p, C-c C-n, C-c C-f, and C-c C-b: move up and down between
  headlines
- Use org-bullets to make it prettier.
...
** Literate programming in with Org-mode
...
#+BEGIN_SRC R :exports none :results output graphics :file mpg.png :cache yes
  ggplot(mpg, aes(displ, cty, colour = class)) +
      geom_point()
#+END_SRC

#+RESULTS[139a354b9019026f272316fe8e3139f97cb24ec0]:
[[file:mpg.png]]

*** The figure generated

#+CAPTION: The Scatterplot Between the Engine Displacement and City MPG
#+ATTR_HTML: :width 500 :height 400
